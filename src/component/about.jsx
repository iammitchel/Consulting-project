      ...
      <section id="service2">
        ...
        <div className="service-text">
          <p>
            ...
            services. With a collective experience spanning [total years] years,
            our consultants bring a rich tapestry of skills and insights to
            address the diverse needs of our clients. Our team excels in
            crafting comprehensive and strategic business plans tailored to each
            client's unique vision and objectives. From startups seeking funding
            to established enterprises planning expansion, we leverage our
            collective experience to provide roadmaps that inspire confidence
            among stakeholders. Our consultants are adept at delving into market
            dynamics, competitor landscapes, and emerging trends to provide
            insightful analyses. Our reports are characterized by meticulous
            research methodologies, clarity in presentation, and a focus on
            delivering actionable intelligence that empowers informed
            decision-making. Navigating the complexities of finance is second
            nature to our team. We employ advanced financial modeling techniques
            to create robust projections and conduct precise valuations.
          </p>
        </div>
      </section>
      <section id="service2">
